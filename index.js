...
if (process.env.NODE_ENV==='production'){
    ...
    //app.use(express.static('client/build')); (from Maximillian)
...
app.post('/api/dailytasksadd', (req, res) => {
    ...
    const note = new MorningTaskAdd({
        ...
        taskListAdministerMedicine: {name: req.body.taskListAdministerMedicine.name, value: req.body.taskListAdministerMedicine.value},
        taskListScheduledShowersWaterTempTest: {name: req.body.taskListScheduledShowersWaterTempTest.name, value: req.body.taskListScheduledShowersWaterTempTest.value},
        taskListScheduledRoomCleaning: {name: req.body.taskListScheduledRoomCleaning.name, value: req.body.taskListScheduledRoomCleaning.value},
        taskListGrooming: {name: req.body.taskListGrooming.name, value: req.body.taskListGrooming.value},
        taskListResidentLaundry: {name: req.body.taskListResidentLaundry.name, value: req.body.taskListResidentLaundry.value},
        taskListActivities: {name: req.body.taskListActivities.name, value: req.body.taskListActivities.value},
        taskListDailyNotes: {name: req.body.taskListDailyNotes.name, value: req.body.taskListDailyNotes.value},
        taskListPrepDinner: {name: req.body.taskListPrepDinner.name, value: req.body.taskListPrepDinner.value},
        taskListSanitizeCountersTable: {name: req.body.taskListSanitizeCountersTable.name, value: req.body.taskListSanitizeCountersTable.value},
